...
from backend.web.core.config import LOCAL_WORKSPACE_ROOT  # noqa: E402
...
from sandbox.config import MountSpec  # noqa: E402
from sandbox.recipes import normalize_recipe_snapshot, provider_type_from_name  # noqa: E402
from sandbox.thread_context import set_current_thread_id  # noqa: E402
...
async def _validate_mount_capability_gate(
    ...
    # @@@request-stage-capability-gate - Fail at create-thread request stage so unsupported mount semantics never enter runtime lifecycle.  # noqa: E501
    return JSONResponse(
        status_code=400,
        content={
