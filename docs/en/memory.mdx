...
|----------|----------|----------|
| Thread history | `$LEON_DB_PATH` | Messages, tool calls, results (LangGraph checkpoints) |
| Sandbox state | `$LEON_SANDBOX_DB_PATH` | Sandbox runtime state, terminal bindings, metrics |
| Queue state | `$LEON_QUEUE_DB_PATH` | Follow-up and notification queue |
