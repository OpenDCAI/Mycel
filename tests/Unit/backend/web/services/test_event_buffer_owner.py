...
def test_thread_runtime_namespace_exports_legacy_helpers() -> None:
    ...
    convergence_shell = importlib.import_module("backend.thread_runtime_convergence")
    ...
    assert convergence_owner.inspect_owner_thread_runtime is convergence_shell.inspect_owner_thread_runtime
