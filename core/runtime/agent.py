...
class LeonAgent:
    ...
    def __init__(
        ...
        *,
        ...
        if self._chat_repos:
            ...
            member_id = repos.get("member_id")
            owner_member_id = repos.get("owner_member_id", "")
            if member_id:
                entity_repo = repos.get("entity_repo")
                entity = entity_repo.get_by_id(member_id) if entity_repo else None
                owner_entity = entity_repo.get_by_id(owner_member_id) if entity_repo and owner_member_id else None
    ...
    def _init_services(self) -> None:
        ...
        owner_eid = self._chat_repos.get("owner_member_id", "") if self._chat_repos else ""
        if owner_eid:
            try:
