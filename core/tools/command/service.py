                ...
                schema={
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            ...
                            "description": {
                                "type": "string",
                                "description": "Human-readable description of what this command does. Required when run_in_background is true; shown in the background task indicator.",  # noqa: E501
                            },
                            "run_in_background": {
                                "type": "boolean",
                                "description": "Run in background (default: false). Returns task ID for status queries.",  # noqa: E501
                            },
                            "timeout": {
                                "type": "integer",
