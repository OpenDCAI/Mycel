...
class SandboxRuntimeRepo(Protocol):
    ...
    def adopt_instance(
        self, *, sandbox_runtime_id: str, provider_name: str, instance_id: str, status: str = "unknown"
    ) -> dict[str, Any]: ...
    def observe_status(self, *, sandbox_runtime_id: str, status: str, observed_at: Any = None) -> dict[str, Any]: ...
...
class SandboxMonitorRepo(Protocol):
    ...
    def query_sandbox_runtime_rows(self, sandbox_id: str) -> list[dict[str, Any]]: ...
    ...
    def query_thread_runtime_rows(self, thread_id: str) -> list[dict[str, Any]]: ...
    def query_resource_rows(self) -> list[dict[str, Any]]: ...
...
class SandboxRepo(Protocol):
    ...
    def update_runtime_binding(self, *, sandbox_id: str, provider_env_id: str | None, updated_at: Any) -> None: ...
    def update_observed_state(self, *, sandbox_id: str, observed_state: str, updated_at: Any) -> None: ...
