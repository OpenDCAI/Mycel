...
class SQLiteQueueRepo:
    ...
    def enqueue(self, thread_id: str, content: str, notification_type: str = "steer",
                source: str | None = None, sender_id: str | None = None, sender_name: str | None = None) -> None:
        with self._lock:
            self._conn.execute(
    ...
    def dequeue(self, thread_id: str) -> QueueItem | None:
        with self._lock:
            ...
            return QueueItem(content=row[0], notification_type=row[1],
                             source=row[2], sender_id=row[3], sender_name=row[4]) if row else None
    ...
    def drain_all(self, thread_id: str) -> list[QueueItem]:
        ...
        return [QueueItem(content=r[0], notification_type=r[1],
                          source=r[3], sender_id=r[4], sender_name=r[5])
    ...
    def _ensure_table(self) -> None:
        ...
        for col, col_type in [("notification_type", "TEXT NOT NULL DEFAULT 'steer'"),
                               ("source", "TEXT"), ("sender_id", "TEXT"), ("sender_name", "TEXT")]:
            try:
